...
def train_model(model, data_dict, fold_num, num_epoch, lr, verbose, params_train, params_validation, seed = 10):
    ...
    parameters :
        ...
        fold_num : int, the number of the fold we are training on
